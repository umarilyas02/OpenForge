...
const BLOCK_PALETTE_META = {
  ...
  "openforge-cms.button": { category: "Basic", icon: RectangleHorizontal },
  "openforge-cms.icon-box": { category: "Basic", icon: Shapes },
  "openforge-cms.divider": { category: "Basic", icon: Minus },
  "openforge-cms.spacer": { category: "Basic", icon: UnfoldVertical },
  "openforge-cms.video": { category: "Basic", icon: Video },
  "openforge-cms.badge": { category: "Basic", icon: Badge },
  ...
  "openforge-cms.carousel-slide": { category: "Content", icon: Frame },
