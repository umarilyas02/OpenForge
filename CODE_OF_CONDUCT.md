...
reported to the project maintainer, [@umarilyas02](https://github.com/umarilyas02),
by opening a private report via
[GitHub's security advisory reporting](https://github.com/umarilyas02/OpenForge/security/advisories/new)
(see `.github/SECURITY.md`) or by contacting the maintainer directly
